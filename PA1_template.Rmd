...
The interval with the maximun number of steps on average across all days is `r activity_data_raw$interval[max_interval]`.    
...
The previous mean total number of steps is `r mean_steps`.  
The updated mean total number of steps is `r mean_steps_update`.  
The previous median total number of steps is `r median_steps`.    
The updated median total number of steps is `r median_steps_update`.  
